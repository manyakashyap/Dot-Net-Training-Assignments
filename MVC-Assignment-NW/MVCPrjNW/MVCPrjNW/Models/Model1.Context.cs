...
namespace MVCPrjNW.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<getCust_Germany_Result> getCust_Germany(string cntry_Name)
        {
            var cntry_NameParameter = cntry_Name != null ?
                new ObjectParameter("cntry_Name", cntry_Name) :
                new ObjectParameter("cntry_Name", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getCust_Germany_Result>("getCust_Germany", cntry_NameParameter);
        }
    
        public virtual ObjectResult<getCustByOrder_Result> getCustByOrder(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getCustByOrder_Result>("getCustByOrder", idParameter);
        }
    
        public virtual ObjectResult<getCustGermany_Result> getCustGermany(Nullable<int> cntry_Name)
        {
            var cntry_NameParameter = cntry_Name.HasValue ?
                new ObjectParameter("cntry_Name", cntry_Name) :
                new ObjectParameter("cntry_Name", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getCustGermany_Result>("getCustGermany", cntry_NameParameter);
        }
    
        public virtual ObjectResult<getGermany_Result> getGermany(string cntry_Name)
        {
            var cntry_NameParameter = cntry_Name != null ?
                new ObjectParameter("cntry_Name", cntry_Name) :
                new ObjectParameter("cntry_Name", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getGermany_Result>("getGermany", cntry_NameParameter);
        }
